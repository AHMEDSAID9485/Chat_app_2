        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('Sign Up',style: TextStyle(color: AppColor.sco_color,fontSize: 20),),
              ],
            ),
            SizedBox(height: 5,),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text('Already have an account?',style: TextStyle(color: AppColor.sco_color,fontSize: 15),),

                GestureDetector(
                  onTap: () => Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => LoginPage())),
                  child: Text(' Sign In',style: TextStyle(color: AppColor.third_color,fontSize: 15,fontWeight: FontWeight.bold),))
              ],
            )
          ],
        ),
